...
type ContainerStatusApplyConfiguration struct {
	...
	LivenessProbeStatus      *corev1.ProbeStatus                     `json:"livenessProbeStatus,omitempty"`
	ReadinessProbeStatus     *corev1.ProbeStatus                     `json:"readinessProbeStatus,omitempty"`
	StartupProbeStatus       *corev1.ProbeStatus                     `json:"startupProbeStatus,omitempty"`
}
...
func (b *ContainerStatusApplyConfiguration) WithLivenessProbeStatus(value corev1.ProbeStatus) *ContainerStatusApplyConfiguration {
...
func (b *ContainerStatusApplyConfiguration) WithReadinessProbeStatus(value corev1.ProbeStatus) *ContainerStatusApplyConfiguration {
...
func (b *ContainerStatusApplyConfiguration) WithStartupProbeStatus(value corev1.ProbeStatus) *ContainerStatusApplyConfiguration {
