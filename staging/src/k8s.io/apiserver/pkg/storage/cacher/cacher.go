...
func NewCacherFromConfig(config Config) (*Cacher, error) {
	...
	watchCache := newWatchCache(
		config.KeyFunc, cacher.processEvent, config.GetAttrsFunc, config.NewFunc, config.Versioner, config.Indexers, config.Clock, config.GroupResource, progressRequester)
